...
import {Table, BelongsTo, Model, Column, DataType, ForeignKey, BeforeCreate} from 'sequelize-typescript';
...
export default class User extends Model<IUserAttributes, IUserCreationAttributes>{
    @Column({
        allowNull: false,
    ...
    static async comparePassword(enteredPassword: string, user: User): Promise<boolean> {
        return await bcrypt.compare(enteredPassword, user.password);
    }

    static async createRefreshJWT (user: ITokenUser, refreshToken: string): Promise<string> {
