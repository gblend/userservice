...
import {Table, BelongsTo, Model, Column, DataType, ForeignKey} from 'sequelize-typescript';
...
export default class Token extends Model<ITokenAttributes, ITokenCreationAttributes> {
    @Column({
        allowNull: false,
