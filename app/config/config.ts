...
export const config = {
  app: {
    ...
    name: process.env.APP_NAME || 'userService',
    env: currentEnv,
    prodEnv: isProdEnv,
    baseUrl: isProdEnv
      ? process.env.BASE_URL_PROD
      : (process.env.BASE_URL_DEV as string),
    secret: process.env.APP_SECRET || ('userService:_xx_default_xx' as string),
    prefix: '/api/v1',
  },
  rateLimiter: {
  ...
  jwt: {
    secret: process.env.JWT_SECRET || ('userService:_xx_default_xx' as string),
